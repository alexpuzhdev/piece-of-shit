...
def forwards_func(apps, schema_editor):
    ...
    data = {
        ...
        "Личное": [
            ...
            "Массаж", "Раскайфовка", "Уход", "Косметика", "Одежда", "Вещи"
        ],
        "Прочее": [
        ...
        "Аренда квартиры": [
            "Аренда", "Аренда квартиры", "Квартира", "Жильё", "Съем квартиры", "Съём"
        ],
        "Коммунальные услуги": [
            "Коммуналка", "ЖКХ", "Услуги", "Свет", "Электричество",
            "Газ", "Вода", "Отопление"
        ],
        "Спорт": [
            "Спорт", "Спортзал", "Фитнес", "Тренировка", "Абонемент",
            "Йога", "Секция", "Бассейн"
        ],
    }
...
class Migration(migrations.Migration):
    dependencies = [
        ("expenses", "0004_alter_budget_options_alter_category_options_and_more"),
    ]
